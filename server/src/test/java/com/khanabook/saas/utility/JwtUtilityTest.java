...
class JwtUtilityTest {
    ...
    void differentRestaurantIds_produceDifferentTokens() {
        String t1 = jwtUtility.generateToken("user@test.com", 1L);
        String t2 = jwtUtility.generateToken("user@test.com", 2L);
    ...
    void largeRestaurantId_preservedExactly() {
        ...
        String token = jwtUtility.generateToken("x@x.com", bigId);
